# This script gives the entire code needed to calculate Watson's two-sample tests of homogeneity 
...
source(here("scripts/higher_level_watson_workflow/watson_functions.R"))
...
watson_output<-data.frame(state=NA, 
                          db1=NA, 
                          db2=NA, 
                          suntime=NA,
                          watson_test_stat=NA, 
...
# 1) FL	Spring_GPS	Spring_Cam
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIRSpringGPS.csv"),
                          path_to_dataset2 = here("data/BIR_Spring_Cams.csv"),
                          db1_name = "FL_Spring_GPS",
                          db2_name = "FL_Spring_Cam",
                          data_type1 = "gps",
                          data_type2 = "cam")
watson_output[1,]<-unlist(tmp)
write_csv(watson_output, here("output/watson_table.csv"))

# 2) FL	summer_GPS	summer_Cam
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIR_Summer_GPS.csv"),
                          ...
                          data_type2 = "cam")
res<-unlist(tmp)
write_csv(as.data.frame(t(res)), here("output/watson_table.csv"), append=T)

# 3) FL	fall_GPS	fall_Cam
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIR_Fall_GPS.csv"),
...
# 4) FL	winter_GPS	winter_Cam
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIR_Winter_GPS.csv"),
...
# 5) FL	fall_GPS_female	fall_gps_male
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sex_comparisons/BIR_FallGPS_Females.csv"),
...
# 6) FL	spring_GPS_female	spring_gps_male
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sex_comparisons/BIR_SpringGPS_Females.csv"),
...
# 7) FL	summer_GPS_female	summer_gps_male
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sex_comparisons/BIR_SummerGPS_Females.csv"),
...
# 8) FL	winter_GPS_female	winter_gps_male
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sex_comparisons/BIR_WinterGPS_Females.csv"),
...
# 12) FL	summer_gps	fall_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIRSummerGPS.csv"),
                          path_to_dataset2 = here("data/BIRFallGPS.csv"),
                          db1_name = "FL_Summer_GPS",
                          db2_name = "FL_Fall_GPS",
                          data_type1 = "gps",
...
# 14) FL	fall_gps	winter_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/BIRFallGPS.csv"),
                          path_to_dataset2 = here("data/BIRWinterGPS.csv"),
                          db1_name = "FL_Fall_GPS",
                          db2_name = "FL_Winter_GPS",
                          data_type1 = "gps",
...
# 15) FL	female_spring_2015_gps	female_spring_2016_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SpringGPS_Females2015.csv"),
...
# 16) FL	female_spring_2016_gps	female_spring_2017_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SpringGPS_Females2016.csv"),
...
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SummerGPS_Females2015.csv"),
...
# 20) FL	female_summer_2016_gps	female_summer_2017_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SummerGPS_Females2016.csv"),
                          path_to_dataset2 = here("data/sexes_by_year/BIR_SummerGPS_Females2017.csv"),
...
# 21) FL	female_fall_2016_gps	female_fall_2017_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_FallGPS_Females2016.csv"),
...
# 22) FL	male_spring_2015_gps	male_spring_2016_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SpringGPS_Males2015.csv"),
...
# 23) FL	male_spring_2016_gps	male_spring_2017_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SpringGPS_Males2016.csv"),
...
# 25) FL	male_summer_2015_gps	male_summer_2016_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SummerGPS_Males2015.csv"),
...
# 26) FL	male_summer_2016_gps	male_summer_2017_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/sexes_by_year/BIR_SummerGPS_Males2016.csv"),
...
# 34) CA	spring_gps	summer_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/tejon_date_fixed/TejonSpringGPS.csv"),
...
# 37) CA	summer_gps	fall_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/tejon_date_fixed/TejonSummerGPS.csv"),
                          path_to_dataset2 = here("data/tejon_date_fixed/TejonFallGPS.csv"),
...
# 39) CA	fall_gps	winter_gps
tmp<-full_watson_workflow(path_to_dataset1 = here("data/tejon_date_fixed/TejonFallGPS.csv"),
                          path_to_dataset2 = here("data/tejon_date_fixed/TejonWinterGPS.csv"),
...
# 43) CA	winter_GPS	winter_Cam
tmp<-full_watson_workflow(path_to_dataset1 = here("data/tejon_date_fixed/TejonWinterGPS.csv"),
                          path_to_dataset2 = here("data/Tejon/Winter_15-16_Cams.csv"),
